    ...
    <>
      <Router>
        <Routes>
          ...
          <Route
            exact
            path="/admin/:userId/tournament/create"
            element={
              <>
                <AdminNavbar></AdminNavbar>
          ...
          <Route
            exact
            path="/admin/:userId/tournament/edit/:id"
            element={
              <>
                <AdminNavbar></AdminNavbar>
                <TournamentAdminEdit />
          ...
          <Route
            exact
            path="/admin/:userId/tournament/:id"
            element={
              <>
                <AdminNavbar></AdminNavbar>
                <TournamentDetail />
          ...
          <Route
            exact
            path="/admin/:userId/tournament/:id/start"
            element={
              <>
                <AdminNavbar></AdminNavbar>
                <TournamentStart />
          ...
          <Route
            exact
            path="/admin/:userId/tournament/:id/completed"
            element={
              <>
                <AdminNavbar></AdminNavbar>
                <TournamentCompleted />
          ...
          <Route
            exact
            path="/user/:userId/tournament/:id/start"
            element={
              <>
                <UserNavbar></UserNavbar>
                <TournamentStartUser />
          ...
          <Route
            exact
            path="/user/:userId/tournament/:id/ended"
            element={
              <>
                <UserNavbar></UserNavbar>
                <TournamentEnded />
          ...
          <Route
            exact
            path="/user/:userId/tournament/:id"
            element={
              <>
                <UserNavbar></UserNavbar>
          ...
          <Route
            exact
            path="/user/:userId/profile/:playerId"
            element={
              <>
                <UserNavbar></UserNavbar>
                <ViewProfile />
