...
export default function Register() {
  ...
  const validateAdminToken = async (token) => {
    try {
      const response = await axios.post(
        "http://localhost:8080/auth/validate-admin-token",
        { token }
      );
  ...
  return (
    <>
      ...
      >
        <div
          className="content is-family-sans-serif fade-in"
          style={{
            height: "100%",
            textAlign: "center",
            display: "flex",
        ...
        >
          <div
            className="form-container animate__animated animate__fadeInUpBig"
            style={{
              height: "65%",
              minHeight: "450px",
          ...
          >
            <form onSubmit={(e) => onSubmit(e)}>
              ...
              <div className="field">
                <label className="label has-text-primary-light">
                  Confirm Password
                </label>
                <div className="control">
                  <input
