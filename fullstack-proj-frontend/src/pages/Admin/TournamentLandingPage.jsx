...
export default function TournamentLandingPage() {
  ...
  const [selectedDropdownContent, setSelectedDropdownContent] =
    useState("Click to filter");
  ...
  const loadTournamentsByCapacity = async (content) => {
    ...
    const result = await axios.get(
      "http://localhost:8080/t/tournaments/capacity"
    );
    if (!result.data.length == 0) {
      setTournament(result.data);
    } else {
              ...
              >
                <div style={{ width: "40%", minWidth: "180px" }}>
                  <Link
                    ...
                    to={`/admin/${userId}/tournament/create`}
                    ...
                    >
                      <div className="dropdown-content">
                        ...
                        <span
                          ...
                          class="dropdown-item"
                          onClick={() => {
                            loadTournamentsByCapacity("Capacity");
                          }}
                        >
                          {" "}
                          Capacity
