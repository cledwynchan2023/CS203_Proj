...
export default function TournamentStart() {
    ...
    const onSubmit= async (e)=>{
        ...
        try {
            const response = await axios.put(`http://ec2-18-143-64-214.ap-southeast-1.compute.amazonaws.com/t/${id}`, tournamentData);
                    ...
                    <div class="card" style={{width:"100%", minWidth:"300px",height:"auto", display:"flex", alignItems:"center", marginBottom:"-10px", backgroundColor: backgroundColor}}>
                        <div class="card-content" style={{display:"flex", justifyContent:"center", overflowX:"scroll", height:"100%", width:"100%", flexWrap:"wrap", backgroundColor:""}}>
                            ...
                            <div class="content" style={{backgroundColor:"", width:"20%", justifyContent:"center", display:"flex", alignItems:"center", gap:"3%", minWidth:"300px", marginTop:"20px"}}>
                                <button className="button is-link" onClick={()=> {handleResult(matchId, -1)}} disabled={isDisabled} style={{width:"30%", minWidth:"100px"}}>Player 1 win</button>
                                <button className="button is-warning" onClick={()=> {handleResult(matchId, 0)}} disabled={isDisabled} style={{width:"30%", minWidth:"100px"}}>Draw</button>
                                <button className="button is-primary" onClick={()=> {handleResult(matchId, 1)}} disabled={isDisabled} style={{width:"30%" , minWidth:"100px"}}>Player 2 win</button>
