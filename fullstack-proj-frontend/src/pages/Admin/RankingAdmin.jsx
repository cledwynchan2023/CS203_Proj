    ...
    switch (activeTab) {
      case "Global":
        return (
          <>
            <section
              className="is-large animate__animated animate__fadeInUpBig"
              style={{
                paddingTop: "30px",
                height: "auto",
                overflowX: "scroll",
              ...
              <table className="table is-hoverable custom-table">
                ...
                <tbody>
                  {user.map((user, index) => (
                    <tr
                      key={user.id}
                      onClick={() => handleRowClick(user, index + 1)}
                    >
              ...
              <div class="modal is-active fade-in">
                ...
                >
                  <header class="modal-card-head" style={{ height: "20%" }}>
                    <p class="modal-card-title" style={{ paddingTop: "5%" }}>
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <div
              style={{ width: "100%", paddingTop: "50px", paddingLeft: "40px" }}
            >
              <p
