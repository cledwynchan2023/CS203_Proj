...
export default function TournamentDetail() {
            ...
            >
              ...
              >
                <div style={{ width: "50%", paddingLeft: "20px" }}>
                  ...
                  >
                    Players: {user.length}/{tournament.size}
                  </p>
                </div>
                <div
                  style={{
  ...
  const deleteTournament = async (tournament_id) => {
    ...
    const result = await axios.delete(
      `http://localhost:8080/admin/tournament/${tournament_id}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  const removePlayer = async (user_id) => {
    try {
      ...
      const response1 = await axios.put(
        `http://localhost:8080/t/${id}/participant/delete?user_id=${user_id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const addPlayer = async (user_id) => {
    try {
      const token = localStorage.getItem("token");
      const response1 = await axios.put(
        `http://localhost:8080/t/${id}/participant/add?user_id=${user_id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
            ...
            <div className="modal is-active fade-in">
              ...
              >
                <header class="modal-card-head" style={{ height: "20%" }}>
                  <p className="modal-card-title" style={{ paddingTop: "5%" }}>
                    Add Player
                  </p>
                  <button
                    className="delete"
                ...
                <footer class="modal-card-foot">
                  <div class="buttons">
                    ...
                    <button
                      class="button"
                      onClick={() => sortUserElo(nonParticpatingUser)}
                    >
                      Sort Elo
                    </button>
                  </div>
