            ...
            <div className="content fade-in" style={{height:"100%",width:"100%", backgroundColor:"rgba(0, 0, 0, 0.5)"}}>
                <section className="section is-large animate__animated animate__fadeInUpBig" style={{ paddingTop:"30px", height:"100%", width:"100%", overflow:"scroll"}}>
                    <div className="hero-body" style={{marginBottom:"20px"}}>
                        <p className="title is-family-sans-serif is-2" style={{width:"100%", fontWeight:"bold", fontStyle:"italic"}}>Player List</p>
                        <button className="button is-link is-rounded" onClick={()=> {setIsModalOpen(true)}}>Create Player</button>
                    </div>
                    <div className=" animate__animated animate__fadeInUpBig" style={{ height:"100%", paddingBottom:"20px",overflowX:"scroll"}}>
