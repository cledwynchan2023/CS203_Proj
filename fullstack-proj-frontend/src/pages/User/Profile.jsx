...
export default function Profile() {
        ...
        return (
          <>
            {isLoading ? (
              ...
              <section
                className="hero animate__animated animate__fadeInUpBig"
                style={{
                  width: "100%",
                  paddingTop: "5%",
                  height: "100%",
  ...
  const findMatch = (matchList) => {
    for (let i = 0; i < matchList.length; i++) {
      if (
        matchList[i].player1 - userId == 0 ||
        matchList[i].player2 - userId == 0
      ) {
        return matchList[i];
      }
    }
          ...
          >
            ...
            >
              ...
              <button
                ...
                onClick={() => deleteUser()}
                style={{ width: "45%", height: "40px", fontWeight: "bold" }}
              >
                Delete
              </button>
            </div>
