...
const getEloChangesFromEachTournament = () => {
  ...
  const renderTabContent = () => {
    ...
    const loadTournaments= async()=>{
        ...
        const result3 = await axios.get(`http://ec2-18-143-64-214.ap-southeast-1.compute.amazonaws.com/u/${playerId}/currentTournament`);
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                const response = await axios.get(`http://ec2-18-143-64-214.ap-southeast-1.compute.amazonaws.com/u/id/${playerId}`, {
                    headers: {
                        'Authorization': `Bearer ${token}`
                    }
                });
