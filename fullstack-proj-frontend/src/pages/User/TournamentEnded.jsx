...
export default function TournamentEnded() {
  ...
  const handlePageClick = (round) => {
    if (round > tournamentRound) {
      ...
      setUserPairings(
        findUserPairingFirst(tournament.rounds[round - 1].matchList)
      );
                    ...
                    >
                      ...
                      >
                        <p className="subtitle" style={{ fontSize: "1rem" }}>
                          {userPairings.player1}
                        </p>
                        <p
                          className="title"
                          style={{ fontSize: "1.8rem", fontWeight: "bold" }}
                        >
                          {userPairings.player1 - userId == 0
                            ? "You"
                            : getUsername(userPairings.player1)}
                        </p>
                      </div>
                      <div
                        style={{
                      ...
                      >
                        <p className="subtitle" style={{ fontSize: "1rem" }}>
                          {userPairings.player2}
                        </p>
                        <p
                          className="title"
                          style={{ fontSize: "1.8rem", fontWeight: "bold" }}
                        >
                          {userPairings.player2 - userId == 0
                            ? "You"
                            : getUsername(userPairings.player2)}
                        </p>
                      </div>
                    </div>
                  </div>
        ...
        return (
          ...
          >
            ...
            >
              <div
                className="card"
                style={{ width: "30%", minWidth: "300px", marginright: "10px" }}
              >
                ...
                <div className="card-content">
                  ...
                  <div className="content">
                    Goal is to checkmate the opponent’s king. Players control 16
                    pieces each, including pawns, rooks, knights, bishops, a
                    queen, and a king.
                    <br />
                  </div>
                </div>
              ...
              >
                ...
                >
                  <div className="card-content">
                    <div className="content">
                      ...
                      >
                        {user.length > 0 && scoreboard.size > 0
                          ? (() => {
                              const entriesArray = Array.from(
                                scoreboard.entries()
                              );
                              const lastEntry =
                                entriesArray[entriesArray.length - 1];
                ...
                <div
                  className="card"
                  style={{ width: "45%", height: "150px", minWidth: "250px" }}
                >
                  <div className="card-content">
                    <div className="content">
                      <p className="subtitle" style={{ fontSize: "1rem" }}>
  ...
  const findUserPairingFirst = (pairings) => {
    for (let i = 0; i < pairings.length; i++) {
      if (
        pairings[i].player1 - userId == 0 ||
        pairings[i].player2 - userId == 0
      ) {
        return pairings[i];
      }
    }
