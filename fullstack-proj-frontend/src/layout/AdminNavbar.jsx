...
const AdminNavbar = () => {
    ...
    return (
        <nav className="navbar" role="navigation" aria-label="main navigation">
            <div class="navbar-brand">
                <a className="navbar-item" href="/admin/${id}/tournament">
            ...
            <div id="navbarBasicExample" className="navbar-menu">
                ...
                <Link 
                                ...
                                style={{ color: location.pathname === `/admin/${id}/tournament` ? 'black' : 'gray', fontSize:"1.5rem" }}
                            >
                                Tournaments
                            </Link>
    ...
    <div className="navbar-end">
      <div className="navbar-item">
        ...
        // <nav className="navbar navbar-expand-lg navbar-info bg-light fixed-top" style={{height:"80px"}}>
        //     <div className="container-fluid" >
        //         <a className="navbar-brand" href={`/admin/${id}/tournament`} style={{fontSize:"1.7rem"}}>ChessComp.io</a>
        ...
        //                         className="nav-link" 
        //                         to={`/admin/${id}/ranking`} 
        //                         style={{ color: location.pathname === `/admin/${id}/ranking` ? 'black' : 'grey', fontSize:"1.5rem"}}
        //                     >
        //                         Ranking
        //                     </Link>
        //                 </li>
        ...
        //                         style={{ color: location.pathname === `/admin/${id}/playerlist` ? 'black' : 'grey', fontSize:"1.5rem" }}
        //                     >
        //                         Player List
        //                     </Link>
        //                 </li>
