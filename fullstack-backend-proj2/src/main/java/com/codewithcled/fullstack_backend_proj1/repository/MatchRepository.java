...
public interface MatchRepository extends JpaRepository<Match, Long> {
     ...
     * Find by checking if the match is complete and if the player is either player 1 or player 2
     * 
     * @param isComplete Will be true
     * @param player1id id of player whose past matches are being searched for, checked if player 1
     * @param isComplete2 Will be true
     * @param player2id id of player whose past matches are being searched for, checked if player 2
     ...
     * Find by checking in a round for a match where the player is either player 1 or player 2
     * 
