...
public interface EloRatingService {
     ...
     * @param elo1    the Elo rating of the first player
     * @param elo2    the Elo rating of the second player
     * @param outcome the outcome of the match (0 for draw, 1 for player 2 wins, 2
     *                for player 1 wins)
    ...
    /**
     * Retrieves the K-value used in Elo rating calculations based on the player's
     * Elo score.
     *
    ...
    /**
     * Calculates the change in Elo rating based on the K-value, win value, and win
     * probability.
     *
     * @param k              the K-value
    ...
    /**
     * Calculates the new Elo ratings for both players based on the outcome of a
     * match.
     *
     * @param elo1    the Elo rating of the first player
     * @param elo2    the Elo rating of the second player
